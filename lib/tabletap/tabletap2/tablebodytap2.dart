          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(
                ...
                height: 15,
                child: Align(
                    alignment: Alignment.centerLeft, child: Text("Custid")),
              ),
              Container(
                width: 400,
                height: 40,
              ...
              SizedBox(
                ...
                height: 15,
                child: Align(
                    alignment: Alignment.centerLeft, child: Text("CustFull")),
              ),
              Container(
                width: 400,
                height: 40,
              ...
              SizedBox(
                ...
                height: 15,
                child: Align(
                    alignment: Alignment.centerLeft, child: Text("CustShort")),
              ),
              Container(
                width: 400,
                height: 40,
              ...
              SizedBox(
                ...
                height: 15,
                child:
                    Align(alignment: Alignment.centerLeft, child: Text("CODE")),
              ),
              EasyDropDown(
                width: 400,
                height: 40,
