  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      child: DataTable(
        ...
        // Header Column -----------------------------------------------------------
        columns: [
          _getDataColumn(1, "ID", 'Sort Field 1', nDataColumnWidth, tapSort),
          _getDataColumn(
              2, "User Name", 'Sort Field 2', nDataColumnWidth, tapSort),
          _getDataColumn(
              3, "Password", 'Sort Field 3', nDataColumnWidth, tapSort),
          _getDataColumn(4, "Name", 'Sort Field 4', nDataColumnWidth, tapSort),
          _getDataColumn(
              5, "Section", 'Sort Field 5', nDataColumnWidth, tapSort),
          _getDataColumn(6, "Role", 'Sort Field 6', nDataColumnWidth, tapSort),
