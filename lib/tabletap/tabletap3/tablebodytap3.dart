...
class _DataListTable3State extends State<DataListTable3> {
  ...
  Widget build(BuildContext context) {
    List<MainStrucTableTap3> Listdata_Clone = widget.datainput;
    ...
    void _tapView(MainStrucTableTap3 s) {
      //click all
      // print("123");
      ListTable3Status = 1;
      EditDataTable3 = s;
      EditDataTable3buffer = s;
    ...
    // }
    void _Edit(MainStrucTableTap3 s) {
      _CloseYNPopup();
    ...
    void _Delete(String s) {
      _CloseYNPopup();
      context.read<FetchDataTable3Bloc>().add(DataSequncePage3.delete);
    }

    void _tapEdit(MainStrucTableTap3 s) {
    ...
    void _tapDelete(MainStrucTableTap3 s) {
      DeleteDataTable3buffer.number = s.number;
      DeleteDataTable3buffer.field01 = s.field01;
      DeleteDataTable3buffer.field02 = s.field02;
      DeleteDataTable3buffer.field03 = s.field03;
            ...
            children: [
              Container(
                ...
                child: ComBtnBlackBorder(
                    ...
                    func: () {
                      ListTable3Status = 0;
                      MainStrucTableTap3 Zerodata = MainStrucTableTap3(
                        number: "",
                        field01: "",
                        field02: "",
                        field03: "",
          ...
          SingleChildScrollView(
            ...
            child: DataTable(
              ...
              columns: [
                ...
                _getDataColumn(2, "Frequency ID", 'Sort Field 2',
                    nDataColumnWidth, tapSort),
                _getDataColumn(
                    3, "Frequency", 'Sort Field 3', nDataColumnWidth, tapSort),
                // _getDataColumn(
...
List<DataRow> _getDataRowList(
  List<MainStrucTableTap3> Listdata_Clone,
  ...
  int nStartCell = (currentPage - 1) * nTableCellPerEachPageTable3;

  List<DataRow> dataRowList = [];
  for (int n = nStartCell;
      n < (nStartCell + nTableCellPerEachPageTable3);
      n++) {
...
void _ConsoleBox(MainStrucTableTap3 input, BuildContext contextinput,
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(
                ...
                height: 15,
                child: Align(
                    alignment: Alignment.centerLeft, child: Text("Frequency")),
              ),
              Container(
                width: 400,
                height: 40,
