...
int ListTable9Status = 0;

class DataListTable9 extends StatefulWidget {
  const DataListTable9({Key? key, required this.datainput}) : super(key: key);
  final List<MainStrucTableTap9> datainput;
  @override
  _DataListTable9State createState() => _DataListTable9State();
}

class _DataListTable9State extends State<DataListTable9> {
  int nCurrentSortIndex = 0; //index from Header DataColumn
  bool isSortAscending = true;

  @override
  Widget build(BuildContext context) {
    List<MainStrucTableTap9> Listdata_Clone = widget.datainput;
    ...
    void _tapView(MainStrucTableTap9 s) {
      //click all
      // print("123");
      ListTable9Status = 1;
      EditDataTable9 = s;
      EditDataTable9buffer = s;
    ...
    // }
    void _Edit(MainStrucTableTap9 s) {
      _CloseYNPopup();
    ...
    void _Delete(String s) {
      _CloseYNPopup();
      context.read<FetchDataTable9Bloc>().add(DataSequncePage9.delete);
    }

    void _tapEdit(MainStrucTableTap9 s) {
    ...
    void _tapDelete(MainStrucTableTap9 s) {
      DeleteDataTable9buffer.number = s.number;
      DeleteDataTable9buffer.field01 = s.field01;
      DeleteDataTable9buffer.field02 = s.field02;
      DeleteDataTable9buffer.field03 = s.field03;
      _CallYNPopup(
          'Delete ${s.number}',
            ...
            children: [
              Container(
                ...
                child: ComBtnBlackBorder(
                    ...
                    func: () {
                      ListTable9Status = 0;
                      MainStrucTableTap9 Zerodata = MainStrucTableTap9(
                        number: "",
                        field01: "",
                        field02: "",
                        field03: "",
          ...
          SingleChildScrollView(
            ...
            child: DataTable(
              ...
              columns: [
                ...
                _getDataColumn(2, "InstrumentId", 'Sort Field 2',
                    nDataColumnWidth, tapSort),
                _getDataColumn(3, "InstrumentName", 'Sort Field 3',
                    nDataColumnWidth, tapSort),
                // _getDataColumn(
...
List<DataRow> _getDataRowList(
  List<MainStrucTableTap9> Listdata_Clone,
  ...
  int nStartCell = (currentPage - 1) * nTableCellPerEachPageTable9;

  List<DataRow> dataRowList = [];
  for (int n = nStartCell;
      n < (nStartCell + nTableCellPerEachPageTable9);
      n++) {
...
void _ConsoleBox(MainStrucTableTap9 input, BuildContext contextinput,
                    ...
                    children: [
                      ComBtnBlack(
                          ...
                          func: () {
                            ...
                            contextinput.read<FetchDataTable9Bloc>().add(
                                DataSequncePage9.update); //<------------------
                          },
                          nWidth: 134),
                      SizedBox(
                        width: 10,
