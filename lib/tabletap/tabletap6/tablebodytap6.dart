...
class DataListTable6 extends StatefulWidget {
  const DataListTable6({Key? key, required this.datainput}) : super(key: key);
      ...
      child: SingleChildScrollView(
        ...
        child: DataTable(
          ...
          columns: [
            ...
            _getDataColumn(
                4, "Samole Type ID", 'Sort Field 4', nDataColumnWidth, tapSort),
            _getDataColumn(
                5, "Samole Name", 'Sort Field 5', nDataColumnWidth, tapSort),
