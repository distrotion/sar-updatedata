...
import 'package:pick_edit_datatable/tabletap/tabletap6/tablestruc6.dart';
...
int ListTable6Status = 0;

class DataListTable6 extends StatefulWidget {
  DataListTable6(
  ...
  @override
  _DataListTable6State createState() => _DataListTable6State();
}

class _DataListTable6State extends State<DataListTable6> {
  int nCurrentSortIndex = 0; //index from Header DataColumn
  bool isSortAscending = true;

  @override
  Widget build(BuildContext context) {
    List<MainStrucTableTap6> Listdata_Clone = widget.datainput;
    ...
    void _tapView(MainStrucTableTap6 s) {
      //click all
      // print("123");
      ListTable6Status = 1;
      EditDataTable6 = s;
    ...
    // }
    void _Edit(MainStrucTableTap6 s) {
      _CloseYNPopup();
    ...
    void _Delete(String s) {
      _CloseYNPopup();
      context.read<FetchDataTable6Bloc>().add(DataSequncePage6.delete);
    }

    void _tapEdit(MainStrucTableTap6 s) {
            ...
            children: [
              Container(
                ...
                child: ComBtnBlackBorder(
                    ...
                    func: () {
                      ListTable6Status = 0;
                      MainStrucTableTap6 Zerodata = MainStrucTableTap6(
                        number: "",
                        field01: "",
                        field02: "",
                        field03: "",
          ...
          SingleChildScrollView(
            ...
            child: DataTable(
              ...
              columns: [
                ...
                _getDataColumn(4, "Samole Type ID", 'Sort Field 4',
                    nDataColumnWidth, tapSort),
                _getDataColumn(5, "Samole Name", 'Sort Field 5',
                    nDataColumnWidth, tapSort),
...
List<DataRow> _getDataRowList(
  List<MainStrucTableTap6> Listdata_Clone,
  ...
  int nStartCell = (currentPage - 1) * nTableCellPerEachPageTable6;

  List<DataRow> dataRowList = [];
  for (int n = nStartCell;
      n < (nStartCell + nTableCellPerEachPageTable6);
      n++) {
...
void _ConsoleBox(MainStrucTableTap6 input, BuildContext contextinput,
    DropDownData dropdowndata) {
  showDialog(
                            ...
                            children: [
                              ...
                              AdvanceDropDown(
                                ...
                                onChangeinside: (newValue) {
                                  GroupType6 = newValue!;
                                  EditDataTable6buffer.field02 = newValue;
                                  undercontroltap6 = true;
                                  _onLoading(
                                      contextinput,
                                      contextinput
                                          .read<CallDropdowndata>()
                                          .add(calldropdownrequrst.set06_1));
